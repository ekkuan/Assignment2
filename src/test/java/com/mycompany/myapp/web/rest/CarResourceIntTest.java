...
public class CarResourceIntTest {
    ...
    private static final Integer DEFAULT_CAR_ID = 1;
    private static final Integer UPDATED_CAR_ID = 2;
    ...
    public void createCar() throws Exception {
        ...
        assertThat(testCar.getCar_id()).isEqualTo(DEFAULT_CAR_ID);
    }
    ...
    public void getAllCars() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].car_id").value(hasItem(DEFAULT_CAR_ID)));
    }
    ...
    public void getCar() throws Exception {
        ...
        restCarMockMvc.perform(get("/api/cars/{id}", car.getId()))
            ...
            .andExpect(jsonPath("$.car_id").value(DEFAULT_CAR_ID));
    }
    ...
    public void updateCar() throws Exception {
        ...
        assertThat(testCar.getCar_id()).isEqualTo(UPDATED_CAR_ID);
    }
